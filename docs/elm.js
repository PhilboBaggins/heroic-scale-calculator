...
var $author$project$Main$Model = function (realWorldMillimetres) {
	return {e: realWorldMillimetres};
};
...
var $author$project$Main$heroicScaleUpper = 50;
var $author$project$Main$inchesTomm = function (inchesVal) {
	return inchesVal * 25.4;
};
		...
		switch (msg.$) {
			...
			case 2:
				...
				return _Utils_update(
					...
					{
						e: function () {
							var _v3 = $elm$core$String$toFloat(value);
							if (_v3.$ === 1) {
								return 0;
							} else {
								var v = _v3.a;
								return v * $author$project$Main$heroicScaleUpper;
							}
						}()
					});
			case 3:
					...
					model,
					{
						e: function () {
							...
							if (_v4.$ === 1) {
								...
								var v = _v4.a;
								return $author$project$Main$inchesTomm(v);
							}
						}()
					});
			case 4:
					...
					model,
					{
						e: function () {
							...
							if (_v5.$ === 1) {
								...
								var v = _v5.a;
								return $author$project$Main$inchesTomm(v * 61);
							}
						}()
					});
			default:
					...
					model,
					{
						e: function () {
							...
							if (_v6.$ === 1) {
								...
								var v = _v6.a;
								return $author$project$Main$inchesTomm(v * $author$project$Main$heroicScaleUpper);
							}
						}()
					});
		}
	});
var $author$project$Main$HeroicInchesLower = function (a) {
	return {$: 4, a: a};
};
var $author$project$Main$HeroicInchesUpper = function (a) {
	return {$: 5, a: a};
};
var $author$project$Main$HeroicMillimetresLower = function (a) {
	return {$: 1, a: a};
};
var $author$project$Main$HeroicMillimetresUpper = function (a) {
	return {$: 2, a: a};
};
var $author$project$Main$RealWorldInches = function (a) {
	return {$: 3, a: a};
};
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Millimetres:')
									])),
								A2(
								$elm$html$Html$td,
								_List_Nil,
								_List_fromArray(
									[
										A4($author$project$Main$viewInput, 'number', 'Real world (mm)', model.e, $author$project$Main$RealWorldMillimetres)
									])),
								A2(
								$elm$html$Html$td,
								_List_Nil,
								_List_fromArray(
									[
										A4($author$project$Main$viewInput, 'number', 'Heroic (lower) (mm)', model.e / 61, $author$project$Main$HeroicMillimetresLower)
									])),
								A2(
								$elm$html$Html$td,
								_List_Nil,
								_List_fromArray(
									[
										A4($author$project$Main$viewInput, 'number', 'Heroic (upper) (mm)', model.e / $author$project$Main$heroicScaleUpper, $author$project$Main$HeroicMillimetresUpper)
									])),
								A2(
								$elm$html$Html$td,
								_List_Nil,
							...
							[
								...
								_List_fromArray(
									[
										...
										'number',
										'Real world (inches)',
										$author$project$Main$mmToInches(model.e),
										$author$project$Main$RealWorldInches)
									])),
								A2(
								$elm$html$Html$td,
								_List_Nil,
								_List_fromArray(
									[
										...
										$author$project$Main$HeroicInchesLower)
									])),
								A2(
								$elm$html$Html$td,
								_List_Nil,
								_List_fromArray(
									[
										...
										$author$project$Main$HeroicInchesUpper)
									])),
								A2(
								$elm$html$Html$td,
								_List_Nil,
